    ...
    return (
        <>
                ...
                <div className="row text-center  mob-card">
                    ...
                    <div className=" col-12 col-md-6 col-lg-4 mb-4">
                        <div className="card" style={{ width: "18rem" }}>
                            <motion.img initial={{ opacity: 1, y: -100, scale: 0.8 }} whileInView={{ opacity: 5, y: 0, scale: 1 }} whileHover={{ scale: 1.1 }} transition={{ duration: "2" }} src="https://media.istockphoto.com/id/1257382919/vector/creative-smart-ideas-icon-blue-vector.jpg?s=612x612&w=0&k=20&c=KyEeXb0zTwdzkkEss7OOCaSIhc_GfvducoqfUuoqBVc=" className="card-img-top" alt="..." />
                    ...
                    <div className="col-12 col-md-6 col-lg-4 mb-4">
                        <div className="card" style={{ width: "18rem" }}>
                            <motion.img initial={{ opacity: 1, y: -100, scale: 0.8 }} whileInView={{ opacity: 5, y: 0, scale: 1 }} whileHover={{ scale: 1.1 }} transition={{ duration: "2" }} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRHLaV1ByBzsgSGva9I1aATZNEQ8CwoY-0YW_BzlHn_-6JNmF36YaF4u-QBfJYrBpel-s0&usqp=CAU" className="card-img-top" alt="..." />
                            <div className="card-body">
            ...
            <div className="container text-center mt-5" >
                ...
                <Link to="/Service" className="btn button-colour button:hover fs-5 mt-5">
